...
Pbp.mailer :user_notifier do
  email :invite do |name, email|
    # Your mailer goes here
    to email
    subject "Invitation"
    locals :nme => name, :email => email
    text_part render 'user_notifier/invitation.plain'
    html_part render 'user_notifier/invitation.html'
  end
end
